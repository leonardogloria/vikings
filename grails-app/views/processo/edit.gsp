...
<html>
    ...
    <body>
        ...
        <div id="edit-processo" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.processo}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.processo}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.processo}" method="PUT">
                <g:hiddenField name="version" value="${this.processo?.version}" />
                <fieldset class="form">
                    <f:all bean="processo"/>
                </fieldset>
