...
<html>
    ...
    <body>
        ...
        <div id="show-processo" class="content scaffold-show" role="main">
            ...
            <f:display bean="processo" />
            <g:form resource="${this.processo}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.processo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
